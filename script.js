...
const roles = ['Software Engineer', 'Full-Stack Developer', 'Problem Solver', 'Code Enthusiast'];
let roleIndex = 0;
let charIndex = 0;
...
// ============================================
// You can add filter buttons to filter projects by technology
...
function filterProjects(technology) {
    ...
    projectCards.forEach(card => {
        ...
        if (technology === 'all' || tags.includes(technology)) {
...
// ============================================
// You can add a light/dark mode toggle button
...
console.log(
    '%cWant to work together? Let\'s connect!',
